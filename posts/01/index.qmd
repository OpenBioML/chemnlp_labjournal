...
In late 2022 Meta (and Papers With Code) released [@galactica], a LLM trained mostly on papers. Interesingly, they also utilized different token(izers) for differetn modalities, for example, citations, protein sequences, and SMILES. They also filtered Common Crawl to scientific subsets. One relevant conclusion for the SMILES-to-IUPAC-name task was
